...
Implemented a client for the `mycord` service called `client` which has the following help menu:
...
This is a Python server implementation provided for testing client locally.
